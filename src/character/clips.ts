...
export function makeClips(): Record<string, THREE.AnimationClip> {
  ...
  // Jump: launch crouch, airborne spread, prepared land.
  const jump = clip("jump", 0.9, [
    { t: 0, pose: { hipL: [0.3, 0, 0], hipR: [0.3, 0, 0], kneeL: [0.5, 0, 0], kneeR: [0.5, 0, 0], chest: [0.1, 0, 0] } },
    { t: 0.18, pose: { hipL: [-0.2, 0, 0], hipR: [-0.2, 0, 0], kneeL: [0.15, 0, 0], kneeR: [0.15, 0, 0], shoulderL: [0, 0, 0.5], shoulderR: [0, 0, -0.5] } },
    { t: 0.6, pose: { hipL: [0.35, 0, 0], hipR: [-0.15, 0, 0], kneeL: [0.6, 0, 0], kneeR: [0.2, 0, 0], shoulderL: [0, 0, 0.35], shoulderR: [0, 0, -0.35] } },
    { t: 0.9, pose: { hipL: [0.3, 0, 0], hipR: [0.3, 0, 0], kneeL: [0.55, 0, 0], kneeR: [0.55, 0, 0], chest: [0.12, 0, 0] } },
  ]);
